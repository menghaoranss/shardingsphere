...
/**
 * Insert values token for broadcast.
 */
public final class BroadcastInsertValuesToken extends InsertValuesToken {
    
    public BroadcastInsertValuesToken(final int startIndex, final int stopIndex) {
