...
/**
 * SphereEx military identity number random replace algorithm.
 */
public final class SphereExMilitaryIdentityNumberRandomReplaceAlgorithm implements MaskAlgorithm<Object, String> {
    ...
    private List<Character> createTypeCodes(final Properties props) {
        MaskAlgorithmPropertiesChecker.checkAtLeastOneChar(props, TYPE_CODE, this);
    ...
    public String getType() {
        return "SphereEx:MILITARY_IDENTITY_NUMBER_RANDOM_REPLACE";
    }
}
