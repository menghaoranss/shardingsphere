...
/**
 * SphereEx telephone random replace algorithm.
 */
public final class SphereExTelephoneRandomReplaceAlgorithm implements MaskAlgorithm<Object, String> {
    ...
    private String getNetworkNumber(final String networkNumber) {
        try {
            ...
            throw new AlgorithmInitializationException(this, String.format("network-number %s can only be integer number", networkNumber));
        }
    }
    ...
    public String getType() {
        return "SphereEx:TELEPHONE_RANDOM_REPLACE";
    }
}
