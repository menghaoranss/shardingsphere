...
/**
 * SphereEx landline number replace algorithm.
 */
public final class SphereExLandlineNumberRandomAlgorithm implements MaskAlgorithm<Object, String> {
    ...
    private List<String> createLandLineNumbers(final Properties props) {
        MaskAlgorithmPropertiesChecker.checkAtLeastOneChar(props, LANDLINE_NUMBERS, this);
    ...
    public String getType() {
        return "SphereEx:LANDLINE_NUMBER_RANDOM_REPLACE";
    }
}
