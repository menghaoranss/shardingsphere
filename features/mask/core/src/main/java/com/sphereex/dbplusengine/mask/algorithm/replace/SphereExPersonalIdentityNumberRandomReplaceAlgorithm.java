...
/**
 * SphereEx personal identity number random replace algorithm.
 */
public final class SphereExPersonalIdentityNumberRandomReplaceAlgorithm implements MaskAlgorithm<Object, String> {
    ...
    public void init(final Properties props) {
        ...
        ShardingSpherePreconditions.checkNotEmpty(alphaTwoCountryAreaCode, () -> new AlgorithmInitializationException(this, "%s can not be empty", ALPHA_TWO_COUNTRY_AREA_CODE));
    }
    ...
    public String getType() {
        return "SphereEx:PERSONAL_IDENTITY_NUMBER_RANDOM_REPLACE";
    }
}
