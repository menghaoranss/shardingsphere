...
class EncryptPredicateValueTokenGeneratorTest {
    ...
    void setup() {
        // SPEX CHANGED: BEGIN
        generator = new EncryptPredicateValueTokenGenerator(EncryptGeneratorFixtureBuilder.createEncryptRule(), Collections.emptyMap(),
    ...
    private Collection<EncryptCondition> getEncryptConditions(final UpdateStatementContext updateStatementContext) {
        // SPEX CHANGED: BEGIN
        return new EncryptConditionEngine(EncryptGeneratorFixtureBuilder.createEncryptRule(), Collections.emptyMap()).createEncryptConditions(updateStatementContext.getWhereSegments());
        // SPEX CHANGED: END
    }
}
