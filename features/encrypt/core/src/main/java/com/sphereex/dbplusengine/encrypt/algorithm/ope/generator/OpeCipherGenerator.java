...
/**
 * Ope cipher generator.
 */
public interface OpeCipherGenerator {
     ...
     */
    OpeCipher generate() throws OpeAlgorithmException;
     ...
     * @throws OpeAlgorithmException OpeAlgorithmException
     */
    OpeCipher decodeCipher(byte[] bytes) throws OpeAlgorithmException;
}
