...
package com.sphereex.dbplusengine.encrypt.rewrite.token.cryptographic.generator.predicate;
...
/**
 * Create alter view predicate value token generator for encrypt.
 */
@HighFrequencyInvocation
@RequiredArgsConstructor
@Setter
public final class EncryptCreateAlterViewPredicateValueTokenGenerator implements CollectionSQLTokenGenerator<SQLStatementContext>, ParametersAware, EncryptConditionsAware {
    ...
    public Collection<SQLToken> generateSQLTokens(final SQLStatementContext sqlStatementContext) {
        EncryptPredicateValueTokenGenerator generator = new EncryptPredicateValueTokenGenerator(rule, databaseEncryptRules, database);
        ...
        return generator.generateSQLTokens(selectStatementContext);
    }
}
