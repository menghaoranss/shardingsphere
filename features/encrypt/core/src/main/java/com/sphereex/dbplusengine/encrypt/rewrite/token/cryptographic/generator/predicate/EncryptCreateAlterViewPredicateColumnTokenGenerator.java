...
/**
 * Create alter view predicate column token generator for encrypt.
 */
@HighFrequencyInvocation
@RequiredArgsConstructor
@Setter
public final class EncryptCreateAlterViewPredicateColumnTokenGenerator implements CollectionSQLTokenGenerator<SQLStatementContext> {
    ...
    public Collection<SQLToken> generateSQLTokens(final SQLStatementContext sqlStatementContext) {
        ...
        return new EncryptPredicateColumnTokenGenerator(rule, databaseEncryptRules, database, metaData).generateSQLTokens(selectStatementContext);
    }
}
