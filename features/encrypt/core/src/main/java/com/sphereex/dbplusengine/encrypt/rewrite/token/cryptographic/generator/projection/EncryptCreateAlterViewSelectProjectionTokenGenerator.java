...
package com.sphereex.dbplusengine.encrypt.rewrite.token.cryptographic.generator.projection;
...
/**
 * Create alter view select projection token generator for encrypt.
 */
@HighFrequencyInvocation
@RequiredArgsConstructor
@Setter
public final class EncryptCreateAlterViewSelectProjectionTokenGenerator implements CollectionSQLTokenGenerator<SQLStatementContext>, PreviousSQLTokensAware {
    ...
    public Collection<SQLToken> generateSQLTokens(final SQLStatementContext sqlStatementContext) {
        ...
        return new EncryptProjectionTokenGenerator(previousSQLTokens, sqlStatementContext.getDatabaseType(), rule, databaseEncryptRules, database, metaData).generateSQLTokens(selectStatementContext);
    }
}
