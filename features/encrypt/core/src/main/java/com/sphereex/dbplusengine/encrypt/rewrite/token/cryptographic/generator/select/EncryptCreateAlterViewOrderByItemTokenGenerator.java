...
/**
 * Create alter view order by item token generator for encrypt.
 */
@HighFrequencyInvocation
@RequiredArgsConstructor
@Setter
public final class EncryptCreateAlterViewOrderByItemTokenGenerator implements CollectionSQLTokenGenerator<SQLStatementContext> {
    ...
    public Collection<SQLToken> generateSQLTokens(final SQLStatementContext sqlStatementContext) {
        ...
        return new EncryptOrderByItemTokenGenerator(rule, database, metaData).generateSQLTokens(selectStatementContext);
    }
}
