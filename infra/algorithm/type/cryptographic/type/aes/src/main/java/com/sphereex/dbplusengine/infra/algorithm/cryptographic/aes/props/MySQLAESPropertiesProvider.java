...
/**
 * MySQL AES properties provider.
 */
public final class MySQLAESPropertiesProvider extends AbstractMySQLTrunkTypeAESPropertiesProvider implements CryptographicPropertiesProvider {
    
    private static final Collection<String> SUPPORTED_MODES = Arrays.asList("ECB", "CBC", "CFB", "OFB");
