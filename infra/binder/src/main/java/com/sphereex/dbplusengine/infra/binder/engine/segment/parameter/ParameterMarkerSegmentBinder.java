...
package com.sphereex.dbplusengine.infra.binder.engine.segment.parameter;
...
public final class ParameterMarkerSegmentBinder {
    ...
    public static Collection<ParameterMarkerSegment> bind(final Collection<ParameterMarkerSegment> parameterMarkerSegments,
        ...
        return parameterMarkerSegments.stream().map(each -> bind(each, parameterMarkerSegmentBoundInfos)).collect(Collectors.toList());
    }
    
    private static ParameterMarkerSegment bind(final ParameterMarkerSegment parameterMarkerSegment, final Map<ParameterMarkerSegment, ColumnSegmentBoundInfo> parameterMarkerSegmentBoundInfos) {
        ...
        // TODO support more ParameterMarkerSegment bound
