...
class MergeStatementBinderTest {
    ...
    void assertBind() {
        ...
        MergeStatement actual = new MergeStatementBinder().bind(mergeStatement, new SQLStatementBinderContext(createMetaData(), "foo_db", new HintValueContext(), mergeStatement));
        ...
        assertThat(((ColumnSegment) actual.getUpdate().get().getSetAssignment().getAssignments().iterator().next().getValue()).getColumnBoundInfo().getOriginalTable().getValue(), is("t_order_item"));
    }
    ...
    void assertBindUpdateDeleteWhere() {
        ...
        assertThat(((ColumnSegment) ((BinaryOperationExpression) actual.getUpdate().get().getDeleteWhere().get().getExpr()).getLeft())
                .getColumnBoundInfo().getOriginalTable().getValue(), is("t_order_item"));
    }
}
