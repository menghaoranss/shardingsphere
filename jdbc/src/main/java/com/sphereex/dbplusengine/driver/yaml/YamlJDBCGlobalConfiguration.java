...
/**
 * YAML global configuration for ShardingSphere-JDBC.
 */
@Getter
@Setter
public final class YamlJDBCGlobalConfiguration implements YamlConfiguration {
    ...
    /**
     * Rebuild YAML JDBC server configuration.
     */
    public void rebuild() {
