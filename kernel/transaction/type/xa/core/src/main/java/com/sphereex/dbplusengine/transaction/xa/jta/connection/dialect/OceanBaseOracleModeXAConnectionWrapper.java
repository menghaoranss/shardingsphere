...
package com.sphereex.dbplusengine.transaction.xa.jta.connection.dialect;
...
/**
 * XA connection wrapper for OceanBase Oracle mode.
 */
public final class OceanBaseOracleModeXAConnectionWrapper implements XAConnectionWrapper {
    ...
    private Class<Connection> getJDBCConnectionClass() {
        return (Class<Connection>) Class.forName("com.oceanbase.jdbc.OceanBaseConnection");
    }
    
    @SneakyThrows(ReflectiveOperationException.class)
    private Constructor<?> getXAConnectionConstructor() {
        return Class.forName("com.oceanbase.jdbc.OceanBaseXaConnection").getConstructor(Class.forName("com.oceanbase.jdbc.OceanBaseConnection"));
    }
