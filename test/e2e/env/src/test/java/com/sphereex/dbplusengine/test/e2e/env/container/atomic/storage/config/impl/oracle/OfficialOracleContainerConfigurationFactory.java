...
/**
 * Official Oracle container configuration factory.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class OfficialOracleContainerConfigurationFactory {
    
    /**
     * Create new instance of official Oracle container configuration.
     *
     * @param scenario scenario
     * @return created instance
     */
    public static StorageContainerConfiguration newInstance(final String scenario) {
        return new StorageContainerConfiguration("", Collections.emptyMap(), getMountedResources(scenario),
    ...
    private static Map<String, String> getMountedResources(final String scenario) {
        ...
        result.put(new ScenarioDataPath(scenario).getInitSQLResourcePath(Type.ACTUAL, TypedSPILoader.getService(DatabaseType.class, "Oracle")) + "/02-loadjava.sh",
                "/docker-entrypoint-initdb.d/startup/02-loadjava.sh");
