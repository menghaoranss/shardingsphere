...
/**
 * Oracle 11g EE container configuration factory.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class Oracle11gEEContainerConfigurationFactory {
    
    /**
     * Create new instance of Oracle 11g EE container configuration.
     *
     * @param scenario scenario
     * @return created instance
     */
    public static StorageContainerConfiguration newInstance(final String scenario) {
        return new StorageContainerConfiguration("", Collections.singletonMap("ORACLE_SID", "ORCL"), getMountedResources(scenario),
    ...
    private static Map<String, String> getMountedResources(final String scenario) {
        ...
        result.put(new ScenarioDataPath(scenario).getInitSQLResourcePath(Type.ACTUAL, TypedSPILoader.getService(DatabaseType.class, "Oracle")) + "/01-actual-init.sql",
                "/docker-entrypoint-initdb.d/startup/01-actual-init.sql");
        result.put(new ScenarioDataPath(scenario).getInitSQLResourcePath(Type.ACTUAL, TypedSPILoader.getService(DatabaseType.class, "Oracle")) + "/02-loadjava-11g.sh",
                "/docker-entrypoint-initdb.d/startup/02-loadjava-11g.sh");
        result.put(new ScenarioDataPath(scenario).getInitSQLResourcePath(Type.EXPECTED, TypedSPILoader.getService(DatabaseType.class, "Oracle")) + "/01-expected-init.sql",
                "/docker-entrypoint-initdb.d/startup/01-expected-init.sql");
        return result;
    }
}
