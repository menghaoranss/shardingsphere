...
/**
 * Official Oracle 11g EE container.
 */
public final class Oracle11gEEContainer extends DockerStorageContainer {
    
    private static final String IMAGE = "quay.io/maksymbilenko/oracle-xe-11g";
    ...
    public Oracle11gEEContainer(final StorageContainerConfiguration storageContainerConfig) {
    ...
    protected void configure() {
        ...
        setWaitStrategy(new JdbcConnectionWaitStrategy(
                () -> DriverManager.getConnection(String.format("jdbc:oracle:thin:@localhost:%s:%s", getFirstMappedPort(), getDefaultDatabaseName().orElse("")), READY_USER, READY_USER_PASSWORD))
                        .withStartupTimeout(Duration.ofMinutes(30L)));
    }
