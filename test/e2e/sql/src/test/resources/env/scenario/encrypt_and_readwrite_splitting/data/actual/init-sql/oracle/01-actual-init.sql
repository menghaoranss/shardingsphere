...
-- SPEX CHANGED: BEGIN
CREATE USER encrypt_write_ds identified by encrypt_write_ds;
GRANT ALL PRIVILEGES TO encrypt_write_ds;
ALTER USER encrypt_write_ds QUOTA UNLIMITED ON USERS;
CREATE USER encrypt_read_ds identified by encrypt_read_ds;
GRANT ALL PRIVILEGES TO encrypt_read_ds;
ALTER USER encrypt_read_ds QUOTA UNLIMITED ON USERS;
-- SPEX CHANGED: END
