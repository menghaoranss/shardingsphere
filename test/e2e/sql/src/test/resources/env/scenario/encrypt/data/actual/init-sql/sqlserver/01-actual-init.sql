...
-- SPEX CHANGED: BEGIN
CREATE TABLE encrypt.t_user (user_id INT PRIMARY KEY, user_name_cipher VARCHAR(50) NOT NULL, user_name_like VARCHAR(50) NOT NULL, user_name_plain VARCHAR(50) NOT NULL, password_plain VARCHAR(50) NOT NULL, password_cipher VARCHAR(50) NOT NULL, email_plain VARCHAR(50) NOT NULL, email_cipher VARCHAR(50) NOT NULL, telephone_cipher CHAR(50) NOT NULL, telephone_like CHAR(11) NOT NULL, telephone_plain CHAR(11) NOT NULL, creation_date DATE NOT NULL);
...
-- SPEX CHANGED: END
-- SPEX ADDED: BEGIN
CREATE TABLE encrypt.t_product_extend (extend_id INT PRIMARY KEY, product_id INT NOT NULL, manual_plain TEXT, manual_cipher TEXT);
