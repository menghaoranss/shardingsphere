...
CREATE TABLE expected_dataset.t_product_category (category_id INT PRIMARY KEY, category_name VARCHAR(50) NOT NULL, parent_id INT NOT NULL, "LEVEL" NUMBER(19,0) NOT NULL, creation_date DATE NOT NULL);
