...
CREATE TABLE write_dataset.t_order (order_id NUMBER(19,0) PRIMARY KEY, user_id INT NOT NULL, status VARCHAR(50) NOT NULL, merchant_id INT NOT NULL, remark VARCHAR(50) NOT NULL, creation_date DATE NOT NULL);
CREATE TABLE write_dataset.t_order_item (item_id NUMBER(19,0) PRIMARY KEY, order_id NUMBER(19,0) NOT NULL, user_id INT NOT NULL, product_id INT NOT NULL, quantity INT NOT NULL, creation_date DATE NOT NULL);
...
CREATE TABLE write_dataset.t_product_category (category_id INT PRIMARY KEY, category_name VARCHAR(50) NOT NULL, parent_id INT NOT NULL, "LEVEL" NUMBER(3,0) NOT NULL, creation_date DATE NOT NULL);
...
CREATE TABLE read_dataset.t_order (order_id NUMBER(19,0) PRIMARY KEY, user_id INT NOT NULL, status VARCHAR(50) NOT NULL, merchant_id INT NOT NULL, remark VARCHAR(50) NOT NULL, creation_date DATE NOT NULL);
CREATE TABLE read_dataset.t_order_item (item_id NUMBER(19,0) PRIMARY KEY, order_id NUMBER(19,0) NOT NULL, user_id INT NOT NULL, product_id INT NOT NULL, quantity INT NOT NULL, creation_date DATE NOT NULL);
...
CREATE TABLE read_dataset.t_product_category (category_id INT PRIMARY KEY, category_name VARCHAR(50) NOT NULL, parent_id INT NOT NULL, "LEVEL" NUMBER(3,0) NOT NULL, creation_date DATE NOT NULL);
