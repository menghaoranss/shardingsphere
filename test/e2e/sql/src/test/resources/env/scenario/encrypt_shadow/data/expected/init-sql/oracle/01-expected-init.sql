...
CREATE USER encrypt_shadow_dataset identified by encrypt_shadow_dataset;
GRANT ALL PRIVILEGES TO encrypt_shadow_dataset;
ALTER USER encrypt_shadow_dataset QUOTA UNLIMITED ON USERS;
