...
CREATE USER encrypt_shadow_db identified by encrypt_shadow_db;
GRANT ALL PRIVILEGES TO encrypt_shadow_db;
ALTER USER encrypt_shadow_db QUOTA UNLIMITED ON USERS;

CREATE TABLE encrypt_shadow_db.t_shadow (order_id NUMBER(19,0) NOT NULL, user_id INT NOT NULL, order_name_cipher VARCHAR(200) NOT NULL, order_name_plain VARCHAR(200) NOT NULL, type_char CHAR(1) NOT NULL, type_boolean BOOLEAN NOT NULL, type_smallint SMALLINT NOT NULL, type_enum VARCHAR2(10) CHECK( type_enum IN ('spring', 'summer', 'autumn', 'winter') ), type_decimal DECIMAL(18,2) NOT NULL, type_date DATE NOT NULL, type_time TIME NOT NULL, type_timestamp TIMESTAMP NOT NULL, PRIMARY KEY (order_id));
