...
CREATE USER write_shadow_dataset identified by write_shadow_dataset;
GRANT ALL PRIVILEGES TO write_shadow_dataset;
ALTER USER write_shadow_dataset QUOTA UNLIMITED ON USERS;

CREATE TABLE write_shadow_dataset.t_shadow (order_id NUMBER(19,0) NOT NULL, user_id INT NOT NULL, order_name VARCHAR(32) NOT NULL, type_char CHAR(1) NOT NULL, type_boolean BOOLEAN NOT NULL, type_smallint SMALLINT NOT NULL, type_enum VARCHAR2(10) CHECK( type_enum IN ('spring', 'summer', 'autumn', 'winter') ), type_decimal DECIMAL(18,2) NOT NULL, type_date DATE NOT NULL, type_time TIME NOT NULL, type_timestamp TIMESTAMP NOT NULL, PRIMARY KEY (order_id));
...
CREATE TABLE read_dataset.t_shadow (order_id NUMBER(19,0) NOT NULL, user_id INT NOT NULL, order_name VARCHAR(32) NOT NULL, type_char CHAR(1) NOT NULL, type_boolean BOOLEAN NOT NULL, type_smallint SMALLINT NOT NULL, type_enum VARCHAR2(10) CHECK( type_enum IN ('spring', 'summer', 'autumn', 'winter') ), type_decimal DECIMAL(18,2) NOT NULL, type_date DATE NOT NULL, type_time TIME NOT NULL, type_timestamp TIMESTAMP NOT NULL, PRIMARY KEY (order_id));
