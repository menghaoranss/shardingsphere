...
package com.sphereex.dbplusengine.test.it.rewrite.fixture.encrypt;
...
@SphereEx
@Getter
public final class RewriteQueryOrderEncryptAlgorithmFixture implements EncryptAlgorithm {
    
    private final EncryptAlgorithmMetaData metaData = new EncryptAlgorithmMetaData(false, false, false, true, (plainCharLength, charToByteRatio) -> plainCharLength);
    ...
    public String encrypt(final Object plainValue, final AlgorithmSQLContext algorithmSQLContext, @SphereEx final EncryptContext encryptContext) {
        return null == plainValue ? null : "order_query_" + plainValue;
    }
    ...
    public String getType() {
        return "REWRITE.ORDER_QUERY.FIXTURE";
    }
}
